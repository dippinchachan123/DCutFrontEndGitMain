...
export const weights = {
    [p.LASER_LOTING]: [p.MARKING_LOTING],
    [p.BOIL_LOTING]: [p.GHAT_LOTING, p.POLISH_LOTING, p.POLISH_TABLE_LOTING, p.MARKING_LOTING,p.POLISHED],
    [p.GHAT_LOTING]: [p.BOIL_LOTING, p.POLISH_LOTING,p.POLISHED],
    [p.MARKING_LOTING]: [p.LASER_LOTING, p.BOIL_LOTING, p.POLISH_LOTING, p.SHAPE_LOTING, p.GHAT_LOTING, p.POLISH_TABLE_LOTING, p.RC, p.ORIGINAL_RC, p.REJECTION, p.POLISHED],
    [p.POLISH_LOTING]: [p.BOIL_LOTING,p.GHAT_LOTING,p.POLISH_LOTING,p.POLISH_TABLE_LOTING,p.POLISHED],
    [p.POLISH_TABLE_LOTING]: [p.GHAT_LOTING,p.BOIL_LOTING,p.POLISH_TABLE_LOTING,p.POLISHED],
    [p.SHAPE_LOTING]: [p.GHAT_LOTING,p.POLISH_LOTING],
    [p.ORIGINAL_RC]: [],
    [p.RC]: [],
    [p.POLISHED]: [],
    [p.REJECTION]: []
